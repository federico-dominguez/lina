...
class TestDeleteBranch:
    ...
    def test_calls_delete(self, monkeypatch):
        ...
        importlib.reload(m)
        respx.delete(
            "https://gitlab.example.com/api/v4/projects/5/repository/branches/feat%2Fx"
...
class TestCreateOrUpdateFile:
    ...
    def test_encodes_base64(self, monkeypatch):
        ...
        route = respx.put(
            "https://gitlab.example.com/api/v4/projects/5/repository/files/README.md"
        ).mock(return_value=httpx.Response(200, json={"file_path": "README.md", "branch": "main"}))
...
class TestMergeMr:
    ...
    def test_puts_merge(self, monkeypatch):
        ...
        importlib.reload(m)
        route = respx.put(
            "https://gitlab.example.com/api/v4/projects/5/merge_requests/2/merge"
        ).mock(
            return_value=httpx.Response(
                200,
                json={
