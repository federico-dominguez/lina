...
export BOT_1_GOOSED_URL="${BOT_1_GOOSED_URL:-http://localhost:3000}"
...
export BOT_2_GOOSED_URL="${BOT_2_GOOSED_URL:-http://localhost:3001}"
...
export BOT_3_GOOSED_URL="${BOT_3_GOOSED_URL:-http://localhost:3002}"
