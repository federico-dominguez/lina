#!/bin/bash
# Goose Gateway — Host-native, solo @s_goose_bot
# Independiente del gateway multi-bot (LINA/Cline/Gemma).
# Si el gateway multi-bot se cae, Goose sigue respondiendo.
#
...
export MULTI_BOT_COUNT="${MULTI_BOT_COUNT:-1}"
...
export BOT_1_GOOSED_SECRET="${GOOSE_SERVER__SECRET_KEY:?GOOSE_SERVER__SECRET_KEY no está en secrets.env}"
...
export BOT_1_OBSERVE_PORT="${BOT_1_OBSERVE_PORT:-9091}"
export BOT_1_FLOOR_TIMEOUT="${BOT_1_FLOOR_TIMEOUT:-45}"
